...
AMiNIMiga has now been completely removed, I decided to remove it completely when Amiga Workbench 3.1 was removed from it, because you need the Workbench 3.1 disks now to run it and it can not be set up to run normally like a Workbench, because of Cloanto copyright issues, this is why I do not agree with Cloanto owning old 68k Amiga copyright when Workbench/Kickstarts 1.0 to 3.1 should be free by now, but it will never be free when people are making money from it 30 years later, all the companies that own Amiga copyright are not the origanl copyright holders, the original Commodore International(CI)(CBM) and HiToro(the original Amiga inc) was and now they only have the copytright to make money from all Amiga copyright like Commodore International(not CI or CBM, they use the same name), they only own the rights to the Commodore name and Chichen Head logo but are not the orignal Commodore(CI(CBM), they are just using there name becouse they have the rights too, like a Commodore Andriod Mobile Phone, OMG... whats next... :(
