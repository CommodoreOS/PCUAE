...
If you hear a echo when you have loaded the carousel in PCUAE, to fix it just press and hold CTRL and the prees 0 to restart TheCarousel and it should sort it.
