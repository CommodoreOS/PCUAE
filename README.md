...
On THEA500 Mini when you remove the PCUAE USB Drive it marks it so makes it think it needs scaning for errors, this is down to RGL not ejecting the USB Drive properly in THEA500 Mini so will always mark the USB Drive and make Windows think it has errors on it when it does not, you can scan it for errors and it will say it `found none`, becuase its false, it does it all the time, its a bug that RGL has never fixed, they need to tell THEA500 Linux System to stop marking the drive for false errors, this is not down too PCUAE, it does it even if you use the USB Drive for just Amiga Games so RGL need to fix it, whats the point of RGL providing a way to update THEA500 Mini then if they never fix anything in it, they should of issued a upade over 6 months a ago, its been over a year now and its still stuck on v1.1.1, well they got there money from it now so are on to the next machine, they might as well not add a way to update the next machine, because there is not point to having it if your not going to update it or fix its probems, like: some games do only work using Amiberries Autoboot lha, not all games load and some games run slow and with broken graphics so THEA500 Mini is not 100% and it should be for a paid product and not have gliches, they should of learn from making THEC64 but retro consoles/computers are just made to make money, nothing more because they are easy to make, they are just a Linux System with a Emulator Front End with a Emulator running in the background thats copied from one of the free emulators out there like Amiberry and VICE, they would not work at all without them, at lesed Nintendo and Sega make there own emulator and not leach of others code they have not even asked to use, so they are not special, they are here just to make money, remeber that, they are not real hardware, 

All the reviews on YouTube about THEA500 Mini, they are YT influencers, they want you to buy it so are paid by RGL to review there product on there channel, that how marketing works now, most stuff no YT is fake now, not like it was 10 years ago, it changed, it all about making money now for videos, when money is invoved it changes things, making YT videos for fun has gone, its now one big advertisment site now, Google has turned YT into a marketing and video streaming site now when it was about about you only, thats why it was called You Tube.
